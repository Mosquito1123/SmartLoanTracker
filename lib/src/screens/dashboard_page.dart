...
class LoanStatsComputedDonutChart extends StatelessWidget {
  final List<charts.Series> seriesList;
  final bool animate;

  LoanStatsComputedDonutChart(this.seriesList, {this.animate});

  /// Creates a [PieChart] with sample data and no transition.
  factory LoanStatsComputedDonutChart.withSampleData() {
    return new LoanStatsComputedDonutChart(
      _createSampleData(),
